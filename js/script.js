...
// const systolicData = [120, 140, 160, 130, 150, 160];  // Example data for systolic readings
// const diastolicData = [80, 70, 78, 65, 75, 78];       // Example data for diastolic readings
...
// // Display whether higher or lower than average
// // document.getElementById('systolicValue').textContent = systolicData[systolicData.length - 1];
// // document.getElementById('diastolicValue').textContent = diastolicData[diastolicData.length - 1];

// // document.getElementById('systolicStatus').textContent = systolicData[systolicData.length - 1] > systolicAvg ? 'Higher than Average' : 'Lower than Average';
// // document.getElementById('diastolicStatus').textContent = diastolicData[diastolicData.length - 1] > diastolicAvg ? 'Higher than Average' : 'Lower than Average';
